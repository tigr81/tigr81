...
def test_extract_template_name(template, expected):
    """
    Test that extract_template_name returns the correct name for various
    types of paths and URLs.
    """
...
def test_extract_template_name_invalid_path(invalid_template):
    """
    Test that extract_template_name raises a ValueError for non-existent
    paths or invalid URLs.
    """
